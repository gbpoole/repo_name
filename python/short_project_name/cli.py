...
import short_project_name.files as files
...
@click.version_option(importlib.metadata.version("short_project_name"))
@click.pass_context
def cli(ctx: click.core.Context) -> None:
    """Run code from the short_project_name package."""
